...
setInputValue(e.target.value)
  ...
  return (
    ...
    <div className="main">
     {Account ? <CreateAccount setAccount={setAccount} />:''}
     {loginInfo ? <LoginInfo setLoginInfo={setLoginInfo} loginInfo = {loginInfo} />:''}
      <div className="mainButton">
        <img src="https://upload.wikimedia.org/wikipedia/en/thumb/1/12/Swiggy_logo.svg/2560px-Swiggy_logo.svg.png"></img>
        <LoginButton className="button1" name="Login"  onClick={()=>setAccount(true)} />
        <LoginButton className="button" name="sign Up" onClick={()=>setLoginInfo(true)} />
      </div>
      <ContentForYou />
      ...
      <OrderInput className="input" onInput={(e)=> handelInput(e)} placeholder="Enter Your Delivery Location"/>
      <LoginButton className="button2" name="FIND FOOD"   /></form>
